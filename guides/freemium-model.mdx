...
Every athlete's first calculate request starts a **30-day trial of full-precision responses, capped at 5 calls per athlete per UTC day**. During the trial, full responses carry trial metadata so you can build countdown UX:
