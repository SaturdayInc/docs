...
- `build_bottling_plan`, `record_bottling_choice` turn the prescription into a bottle-by-bottle plan the athlete owns and edits in Saturday, and record the plan they commit to. [Bottling plans](/guides/mcp-integration#bottling-plans) has the arguments and result shape.
