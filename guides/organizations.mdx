...
Checkout applies one combined discount, and Saturday's subscribe landing page shows the stacked percent, the exact number the athlete will pay, along with which sources contributed. See [Freemium Model, How discounts stack](/guides/freemium-model#how-discounts-stack) for the full discount flow.
