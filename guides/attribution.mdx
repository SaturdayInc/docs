{/* DRAFT: brand + legally sensitive. Pending Alex + counsel review before this PR merges. */}
---
...
Saturday provides the "Powered by Saturday" mark in light and dark variants, horizontal and
stacked, as a drop-in asset. Use the asset as shipped.

<Frame>
  <img src="/images/powered-by-saturday.svg" alt="Powered by Saturday" height="28" noZoom />
</Frame>

- **Minimum size:** 16px tall on screen (20px or larger recommended), 6mm in print. Below that,
  use the plain-text form.
...
<div class="nutrition">
  ...
  <a href="https://saturday.fit/subscribe?ref=your_partner_id" class="saturday-attribution">
    <img src="https://saturday.fit/brand/powered-by-saturday/powered-by-saturday-horizontal-dark.svg"
         alt="Powered by Saturday" height="20">
  </a>
</div>
```
...
Column(
  ...
  children: [
    ...
    GestureDetector(
      ...
      child: SvgPicture.asset('assets/powered-by-saturday.svg', height: 20),
    ),
  ],
)
```
...
<Card title="Saturday brand kit" icon="download" href="https://saturday.fit/brand">
  The "Powered by Saturday" and "Compatible with Saturday" marks (light and dark, horizontal and
  stacked, SVG and PNG) plus ready-to-paste HTML and Flutter snippets. Download the kit at
