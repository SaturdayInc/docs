...
- **Keep your brand dominant.** The Saturday mark appears near your own name, stays separate from
  it, and is never larger or more prominent than your own branding.
...
that shape unless your platform already applies its own icon mask or your design system has a
...
Attribution rides alongside the data-use terms every response already carries in its
