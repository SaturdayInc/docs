...
[brand kit](https://saturday.fit/brand/app-icon/) ships it at eight sizes, 24px through 1024px, as
full-bleed squares with no pre-rounded corners: apply your platform's own corner mask, use 48px or
larger where the surface allows (24px is the floor), and do not recolor, crop, or add effects. The
icon identifies the Saturday app; the marks credit Saturday data. Both can appear on one screen
