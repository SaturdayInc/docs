...
| **Individual API** | Dev-athletes, AI-assisted coaching businesses, team-scale builders | **your system** | self-serve `sk_` key | $5.39/month, no contract |
...
You are building a product, tooling, or a coaching stack, and athletes live in **your** database.
...
`GET https://api.saturday.fit/v1/` (no auth) self-describes the API: the endpoints exposed to your key, plan, price, trial shape, and both signup paths. Site context: [saturday.fit/llms.txt](https://saturday.fit/llms.txt).
